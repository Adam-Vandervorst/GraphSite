...
class Generator:
    ...
    def convert_markdown(self, id_titles=(2, 3), missing_pages_class="missing", external_new_tab=True, internal_field=None, wbr_code=True):
        ...
        transformation = ProcessLinks(name_exists, id_titles, missing_pages_class, external_new_tab, internal_field is not None, wbr_code)
